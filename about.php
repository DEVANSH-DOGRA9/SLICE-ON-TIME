      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Slice On Time</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Devansh Dogra</h2><p>CE084 <a href="https://github.com/DEVANSH-DOGRA9" target="_blank">@DEVANSH-DOGRA9</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Slice On Time</strong></h3>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
        <div class="member">
            <img src="assets/img/team/dd.png" style="width: 100%; height: 200px; object-fit: cover;" alt="">
            <div class="member-info">
                ...
                <div class="social">
                    ...
                    <a href="https://github.com/DEVANSH-DOGRA9" target="_blank"><i class="fab fa-github"></i></a>
                    <a href="https://www.linkedin.com/in/devansh-dogra-97643a254/" target="_blank"><i class="icofont-linkedin"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
        <div class="member">
            <img src="assets/img/team/dd1.png" style="width: 100%; height: 200px; object-fit: cover;" alt="">
            <div class="member-info">
                <div class="member-info-content">
                    <h4>Devansh Dogra</h4>
                </div>
                <div class="social">
                    ...
                    <a href="https://github.com/DEVANSH-DOGRA9" target="_blank"><i class="fab fa-github"></i></a>
                    <a href="https://www.linkedin.com/in/devansh-dogra-97643a254/"><i class="icofont-linkedin"></i></a>
                </div>
            </div>
        </div>
    </div>
